...
public class AssignServiceImpl implements AssignService {
	 ...
	 * void begin() throws TransactionException; 开启一个全局事务（使用默认的事务名和超时时间）
	 * void begin(int timeout) throws TransactionException; 开启一个全局事务，并指定超时时间（使用默认的事务名）
	 * void begin(int timeout, String name) throws TransactionException; 开启一个全局事务，并指定事务名和超时时间
	 * void commit() throws TransactionException; 全局提交
	 * void rollback() throws TransactionException; 全局回滚
	 * GlobalStatus getStatus() throws TransactionException; 获取事务的当前状态
	 * String getXid(); 获取事务的 XID
	 * @param id
	 * @return
	 */
	@Override
