package com.leelovejava.sharding.config;

import com.alibaba.druid.pool.DruidDataSource;
import com.leelovejava.sharding.config.algorithm.DatabaseShardingAlgorithm;
import com.leelovejava.sharding.config.algorithm.StaffTableComplexKeysShardingAlgorithm;
import com.leelovejava.sharding.config.algorithm.StaffTableTableShardingAlgorithm;
...
public class ShardingConfig {
    ...
    private Map<String, DataSource> getDatasourceMap() {
        ...
        dataSourceYounger.setUsername(username);
        dataSourceYounger.setPassword(password);
        ...
        dataSourceOlder.setPassword("root");
