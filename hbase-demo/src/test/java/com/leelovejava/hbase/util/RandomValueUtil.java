package com.leelovejava.hbase.util;
...
public class RandomValueUtil {
     ...
     *
     * @return
     * @see 'http://www.cnblogs.com/feifeicui/p/8572343.html'
     */
    ...
    public static String getType() {
        ...
        return String.valueOf(r.nextInt(2) + 1);
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 100; i++) {
            System.out.println(getCallLength());
